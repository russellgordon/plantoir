...
(9d4bf2a6) and reads **172** after: `deployAtATime.asked` (9) is new, and has
...
neither a new list; `activityTrail.mustRecord` is unchanged at 70 (the event
