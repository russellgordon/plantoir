...
from **ENG3U — English, Grade 11, University Preparation**. Lesson pages link here so you can always
...
The four strands are taught together rather than in turn: you read to
write, write about what you read, and talk about all of it.

```mermaid
graph TD
    A["A. Oral Communication"] --> B["B. Reading and Literature Studies"]
    B --> C["C. Writing"]
    C --> D["D. Media Studies"]
    D --> A
```
