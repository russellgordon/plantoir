...
Marks are meant to rest on three kinds of evidence: what students make, what you
watch them do, and what they tell you. The first arrives on its own. Fill in the
other two here, for THIS task, and nobody else ever sees this note — it is a
...
OBSERVE — Unit ?, Day ?, which period
  ...
  finished piece. In a physics task that is usually a habit of measuring —
  whether a doubtful reading is taken again, whether one variable changes at a
  time, whether the convention is chosen before the answer is known. If you
  cannot name one, the task may be worth rethinking.
  Going well:
  Stuck:
...
TALK — Unit ?, Day ?, ideally a conference the schedule already has
  ...
  Ask: a real question, in the words you would say — and one that is not already
  printed on this page, or they will have rehearsed it.
  Then: a second one
