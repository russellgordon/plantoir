...
> Everything below is a placeholder written for an environmental science course. Edit it,
...
2. Investigation: predict, then test — [[Investigations/index|Investigations]]
3. Consolidate: compare methods, then name the idea — [[Concepts/index|Concepts]]
4. Practice: a short set — [[Fieldwork/index|Fieldwork]]
5. Exit question
