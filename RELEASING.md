...
| 2026-09-19 | **A publish that ran on its own tells you the moment it finishes.** The note appears at the top of the section while you are looking at it — it used to wait until the section was left and reopened, and sat mid-window — and the warning beside a section in the sidebar says what it means when the pointer rests on it. Holds for a publish scheduled before updating, too. | macOS — Windows is asked to check its own note ([#218](https://github.com/russellgordon/plantoir/issues/218)). The note is new in this release. | [504](GUI-IMPROVEMENTS.md) |
