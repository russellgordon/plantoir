...
> Everything below is a placeholder written for an arts course. Edit it,
...
An arts class asks people to try things in front of each other. That
...
> studio itself — write them here or on their own page, and record the
