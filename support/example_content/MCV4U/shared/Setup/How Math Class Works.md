...
whole point.[^1] This is the calculus room, and calculus is far too
good to be dictated.
...
you have wrestled with it, not before — the shrinking secants before
the word "limit", the slopes conjectured from data before anyone
says "power rule". Marker in hand, one rule: the person holding the
...
and not the checkpoint at the end of the unit, are the first to know what
