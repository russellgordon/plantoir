...
**193** after: `assist-cases.json` → `linksQuestion.accepted` (27),
`.anotherCourse` (6), `.refused` (23), `.answering.section` (7),
`.answering.cases` (12) and `.answering.lookup` (6), none with a Windows
