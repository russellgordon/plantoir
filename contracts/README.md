...
`recognition.cases` (20), `codeAndYear.cases` (9),
`sharedFolder.chosenCases` (4), `placement.cases` (4) and `rejected` (11) —
...
the table, for the same reason #206's lists do.
