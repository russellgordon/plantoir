...
nonisolated enum UnitWordRenameWording {
    ...
    /// phrase for one idea.
    static let fieldLabel: String = "What do you call a unit?"

    /// The button that opens the sheet.
    static let renameButton: String = "Rename…"
    ...
    static func sheetTitle(for word: String) -> String {
        return "Rename “\(word)”"
    }
    ...
    static func rowCaption(word: String) -> String {
    ...
    static func problemMustFinishFirst(target: String) -> String {
    ...
    static func problemRecordNotWritten(reason: String) -> String {
    ...
    static func doneLinksNotWritten(pages: Int) -> String {
        if pages == 1 {
    ...
    static func problemPageInTheWay(courseCode: String, sectionNumber: Int, name: String) -> String {
    ...
    static func problemPageUnreadable(courseCode: String, sectionNumber: Int, name: String) -> String {
    ...
    static func problemBusy(courseCode: String) -> String {
    ...
    static func previewLinks(count: Int) -> String {
        if count == 0 {
    ...
    static func done(from old: String, to new: String) -> String {
        return "“\(old)” is now “\(new)”."
    }

    static func donePages(count: Int) -> String {
        if count == 0 {
    ...
    static func doneLinks(count: Int) -> String {
        if count == 0 {
    ...
    static func interruptedRename(from old: String, to new: String) -> String {
    ...
    static func halfDone(renamed: Int, of total: Int, stoppedAt name: String, reason: String) -> String {
    ...
    static func settingsNotWritten(new: String, reason: String) -> String {
    ...
    static func sectionsPhrase(_ numbers: [Int]) -> String {
        var spelled: [String] = []
