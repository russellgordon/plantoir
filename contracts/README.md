...
open issue, or exempt for a reason written down here.** **119 case lists; 102
have a reader here.** The other seventeen are below. (It was 100 of 111 when this
...
`outsideAgents.agents` made it **119**, re-taken with the walker the same way. **This is the failure mode the
