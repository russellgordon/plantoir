...
When an idea in hairstyling and aesthetics needs explaining more than once,
it belongs here rather than inside a lesson plan — then every class that
touches it can link to the same page.
