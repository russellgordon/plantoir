...
enum SiteHealthRepair {
    ...
    /// (documentation/05-build-pipeline.md, 2026-09-06) and shipped this shape first; the mac is
    ...
    /// it reads namelessly too until documentation/05-build-pipeline.md lands.
