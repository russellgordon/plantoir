...
1. **The idea, in your own words.** Not the definition from the site —
   yours. If they match word for word, you copied rather than understood.
2. **One worked example** you chose, with the reasoning written out.
3. **One thing that is still murky**, stated as a question.

Three quarters of a page is plenty. Consistency beats volume.

## Why in your own words

Because the moment you try to explain acceleration without using the word
"acceleration", you find out whether you have it. This is the cheapest
diagnostic in the course and the one students skip most.
