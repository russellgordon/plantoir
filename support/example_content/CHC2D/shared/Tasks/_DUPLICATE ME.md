...
Keep this note OUTSIDE the curriculum markers below. Anything between them is deleted for a teacher who declines curriculum pages, and a note nested inside would vanish with them.
%%
...
Marks are meant to rest on three kinds of evidence: what students make, what
you watch them do, and what they tell you. The first arrives on its own.
Fill in the other two here, for THIS task. Nobody else ever sees this note —
it is a comment, so it never appears on the website.
