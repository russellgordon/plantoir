...
OBSERVE — Unit ?, Day ?, which period
  ...
  finished piece. At a bench that is usually technique: a doubtful reading
  repeated rather than tidied, one variable changed at a time, a control set up
  beside the test. If you cannot name one, the task may be worth rethinking.
  Going well:
  Stuck:
