...
public static class TaskScheduling
{
    ...
    /// path to the same record" in documentation/07-deployment.md: unlike the mac, whose
        ...
        IReadOnlyList<CourseConfiguration.DeployDestination> destinations, string cloudflareAccountID)
    {
        try
        {
            ...
            var lines = new List<string>
            {
                ...
                "# See TaskScheduling.WriteWrapperScript and documentation/07-deployment.md,",
