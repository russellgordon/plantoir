...
> Everything below is a placeholder written for an earth and space science course. Edit it,
...
An earth and space science class asks people to try things in front of each other. That
...
> lab itself — write them here or on their own page, and record the
