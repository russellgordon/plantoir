...
Windows session, 2026-09-06 — the numbers have shifted since); 41 and 42 were
added by the wording work of 2026-09-07/08. Item 39 was written up at 09:33 on
2026-09-07 and given no row here for twelve hours, which is exactly the drift
the rule below exists to stop; item 41 was given one in the session that
